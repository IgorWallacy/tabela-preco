  ...
  const salvarLocalStroagre = () => {
    ...
    if (lojaSelecionada && tabelaSelecionada) {
      ...
      toast.current.show({
        severity: "warn",
        summary: "Atenção",
        detail: "Selecione a loja e tabela para exibição",
        life: 3000,
      });
    }
  };
    ...
    <>
      ...
      <div className="w-full flex justify-center items-end gap-5">
        ...
        <div className="text-2xl">
          ...
          <InputSwitch
            checked={usarSenhaPreferencial}
            onChange={(e) => setUsarSenhaPreferencial(e.value)}
          />
        </div>
        ...
        <div className="text-2xl">
          ...
          <InputSwitch
            checked={usarSenhaNormal}
            onChange={(e) => setUsarSenhaNormal(e.value)}
          />
        </div>

        <Button
          onClick={() => salvarLocalStroagre()}
          style={{ margin: "5px" }}
          icon="pi pi-save"
          label="Gravar"
